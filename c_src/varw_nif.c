...
static int varw_load(ErlNifEnv* env, void** priv_data, ERL_NIF_TERM load_info);
static int varw_upgrade(ErlNifEnv* env, void** priv_data, void** old_priv_data, 
                         ERL_NIF_TERM load_info);
static void varw_unload(ErlNifEnv* env, void* priv_data);

static ERL_NIF_TERM varw_new(ErlNifEnv* env, int argc,
			     const ERL_NIF_TERM argv[]);

static ERL_NIF_TERM varw_add_variable(ErlNifEnv* env, int argc,
				      const ERL_NIF_TERM argv[]);
static ERL_NIF_TERM varw_add_clause(ErlNifEnv* env, int argc,
				    const ERL_NIF_TERM argv[]);
static ERL_NIF_TERM varw_get_clause(ErlNifEnv* env, int argc,
				    const ERL_NIF_TERM argv[]);
static ERL_NIF_TERM varw_get_clause_flags(ErlNifEnv* env, int argc,
					  const ERL_NIF_TERM argv[]);
static ERL_NIF_TERM varw_get_clauses(ErlNifEnv* env, int argc,
				     const ERL_NIF_TERM argv[]);
static ERL_NIF_TERM varw_get_queue_first(ErlNifEnv* env, int argc,
					 const ERL_NIF_TERM argv[]);
static ERL_NIF_TERM varw_get_queue_next(ErlNifEnv* env, int argc,
					const ERL_NIF_TERM argv[]);
static ERL_NIF_TERM varw_clear_queue(ErlNifEnv* env, int argc,
				     const ERL_NIF_TERM argv[]);
static ERL_NIF_TERM varw_enqueue_all(ErlNifEnv* env, int argc,
				     const ERL_NIF_TERM argv[]);
static ERL_NIF_TERM varw_get_bindings(ErlNifEnv* env, int argc,
				      const ERL_NIF_TERM argv[]);
static ERL_NIF_TERM varw_get_nbindings(ErlNifEnv* env, int argc,
				       const ERL_NIF_TERM argv[]);

static ERL_NIF_TERM varw_del_clause(ErlNifEnv* env, int argc,
				    const ERL_NIF_TERM argv[]);

static ERL_NIF_TERM varw_info(ErlNifEnv* env, int argc,
			      const ERL_NIF_TERM argv[]);
static ERL_NIF_TERM varw_get(ErlNifEnv* env, int argc,
			       const ERL_NIF_TERM argv[]);
static ERL_NIF_TERM varw_put(ErlNifEnv* env, int argc,
			     const ERL_NIF_TERM argv[]);
static ERL_NIF_TERM varw_is_variable(ErlNifEnv* env, int argc,
				     const ERL_NIF_TERM argv[]);
static ERL_NIF_TERM varw_is_bound(ErlNifEnv* env, int argc,
				  const ERL_NIF_TERM argv[]);
static ERL_NIF_TERM varw_class(ErlNifEnv* env, int argc,
			       const ERL_NIF_TERM argv[]);
static ERL_NIF_TERM varw_class_next(ErlNifEnv* env, int argc,
				    const ERL_NIF_TERM argv[]);
static ERL_NIF_TERM varw_key(ErlNifEnv* env, int argc,
			     const ERL_NIF_TERM argv[]);
static ERL_NIF_TERM varw_implication_clause(ErlNifEnv* env, int argc,
					    const ERL_NIF_TERM argv[]);
static ERL_NIF_TERM varw_conflicting_clause(ErlNifEnv* env, int argc,
					 const ERL_NIF_TERM argv[]);
static ERL_NIF_TERM varw_is_equal(ErlNifEnv* env, int argc,
				  const ERL_NIF_TERM argv[]);
static ERL_NIF_TERM varw_mark(ErlNifEnv* env, int argc,
			     const ERL_NIF_TERM argv[]);
static ERL_NIF_TERM varw_remove_mark(ErlNifEnv* env, int argc,
				     const ERL_NIF_TERM argv[]);
static ERL_NIF_TERM varw_undo(ErlNifEnv* env, int argc,
			      const ERL_NIF_TERM argv[]);
static ERL_NIF_TERM varw_eval(ErlNifEnv* env, int argc,
			      const ERL_NIF_TERM argv[]);
static ERL_NIF_TERM varw_order_first(ErlNifEnv* env, int argc,
				     const ERL_NIF_TERM argv[]);
static ERL_NIF_TERM varw_order_next(ErlNifEnv* env, int argc,
				    const ERL_NIF_TERM argv[]);
static ERL_NIF_TERM varw_order_sort(ErlNifEnv* env, int argc,
				    const ERL_NIF_TERM argv[]);
static ERL_NIF_TERM varw_order_sort_first(ErlNifEnv* env, int argc,
					  const ERL_NIF_TERM argv[]);
static ERL_NIF_TERM varw_order_sort_last(ErlNifEnv* env, int argc,
					 const ERL_NIF_TERM argv[]);

static ERL_NIF_TERM varw_add_symbol(ErlNifEnv* env, int argc,
				    const ERL_NIF_TERM argv[]);
static ERL_NIF_TERM varw_get_symbol(ErlNifEnv* env, int argc,
				    const ERL_NIF_TERM argv[]);
static ERL_NIF_TERM varw_find_symbol(ErlNifEnv* env, int argc,
				     const ERL_NIF_TERM argv[]);
...
typedef struct _variable_t  // :object_t
{
    ...
    int cix;                  // implication clause index -1 = none
    long li;                  // position in implication clause
...
#define UNDO_BLOCK_SIZE 1024

typedef enum {
    NONE = 0,  // patched position
    VARIABLE,  // addr=variable, value=variable-value
    MARK,      // addr=old-mark, value=mark-value
...
typedef struct _undo_t
{
    ...
    size_t value_stack_size; // number of value bindings in undo stack
    int mark;           // current mark
    undo_block_t* ubp;  // current block
    undo_block_t* fubp; // free block list
...
#define VARW_FALSE(vp) ((vp)->lfalse)

ErlNifResourceType* varw_res;

ErlNifFunc varw_funcs[] = 
{
    NIF_FUNC( "new",                 0,  varw_new ),
    NIF_FUNC( "new",                 1,  varw_new ),
    NIF_FUNC( "info",                2,  varw_info ),
    ...
    NIF_FUNC( "conflicting_clause",     1,  varw_conflicting_clause ),
    NIF_FUNC( "is_variable",         2,  varw_is_variable ),
    NIF_FUNC( "is_bound",            2,  varw_is_bound ),
    NIF_FUNC( "class_next",          2,  varw_class_next ),
    NIF_FUNC( "is_equal",            3,  varw_is_equal ),
    NIF_FUNC( "mark",                2,  varw_mark ),
    NIF_FUNC( "remove_mark",         2,  varw_remove_mark ),
    NIF_FUNC( "undo",                1,  varw_undo ),
    NIF_FUNC( "undo",                2,  varw_undo ),
    NIF_FUNC( "eval",                1,  varw_eval ),
    NIF_FUNC( "add_clause",          3,  varw_add_clause ),
    NIF_FUNC( "add_clause",          4,  varw_add_clause ),
    NIF_FUNC( "add_clause",          5,  varw_add_clause ),
    NIF_FUNC( "add_clause",          6,  varw_add_clause ),
    NIF_FUNC( "add_clause",          7,  varw_add_clause ),
    NIF_FUNC( "add_clause",          8,  varw_add_clause ),
    NIF_FUNC( "get_clause",          2,  varw_get_clause ),
    NIF_FUNC( "get_clause_flags",    2,  varw_get_clause_flags ),
    NIF_FUNC( "del_clause",          2,  varw_del_clause ),
    NIF_FUNC( "get_clauses",         2,  varw_get_clauses ),
    NIF_FUNC( "get_queue_first",     1,  varw_get_queue_first ),
    NIF_FUNC( "get_queue_next",      2,  varw_get_queue_next ),    
    NIF_FUNC( "clear_queue",         1,  varw_clear_queue ),
    NIF_FUNC( "enqueue_all",         1,  varw_enqueue_all ),
    NIF_FUNC( "get_bindings",        3,  varw_get_bindings ),
    NIF_FUNC( "get_nbindings",       3,  varw_get_nbindings ),
    NIF_FUNC( "order_first",         1,  varw_order_first ),
    NIF_FUNC( "order_next",          3,  varw_order_next ),
    NIF_FUNC( "order_sort",          4,  varw_order_sort ),
    NIF_FUNC( "order_sort_first",    2,  varw_order_sort_first ),
    NIF_FUNC( "order_sort_last",     2,  varw_order_sort_last ),
    NIF_FUNC( "add_symbol",          3,  varw_add_symbol),
    NIF_FUNC( "get_symbol",          2,  varw_get_symbol ),
    NIF_FUNC( "find_symbol",         2,  varw_find_symbol ),
};
...
static inline int lit_value(varw_t* vp, lit_t lp)
{
#ifdef LIT_INTEGER
...
static inline literal_t* lit_literal(varw_t* vp, lit_t lp)
{
#ifdef LIT_INTEGER
...
static inline variable_t* lit_variable(varw_t* vp, lit_t lp)
{
#ifdef LIT_INTEGER
...
static char* lit_format(varw_t* vp, lit_t lp)
{
    static char varname[32];    
#ifdef LIT_INTEGER
    char* n = (lp < 0) ? "!" : "";
...
static char* literal_format(varw_t* vp, literal_t* lp)
{
    static char varname[32];    
    UNUSED(vp);
    char* n = (lp->sign < 0) ? "!" : "";
...
static void* varw_alloc(allocator_t* ap)
{
    object_t* ptr;
...
#if 0
static void varw_free(allocator_t* ap, object_t* ptr)
{
...
static void unwatch(varw_t* vp, clause_t* cp, lit_t lp)
{
...
static void clause_free(varw_t* vp, clause_t* cp)
{
    UNUSED(vp);
    free(cp);
}
...
static void lqueue_enq(varw_t* vp, lit_t lp)
{
    lqueue_t* q = &vp->q;
    literal_t* mp;
    DBG("ENQ %s qsize=%ld\r\n", lit_format(vp, lp), q->size);
    assert(lit_value(lp) == UNDEF);
#ifdef LIT_INTEGER
...
static literal_t* lqueue_deq(varw_t* vp)
{
    lqueue_t* q = &vp->q;
    literal_t* lp;
...
static void undo_init(undo_t* up)
{
    up->stack_size = 0;
    up->value_stack_size = 0;
    up->mark = 0;
    up->ubp = NULL;
    up->fubp = NULL;
    up->top = NULL;
...
static int undo_add_block(undo_t* up)
{
    ...
    if (up->fubp != NULL) {  // we have free blocks
	ubp = up->fubp;
	up->fubp = ubp->next;
    }
    else {
	if ((ubp = enif_alloc(sizeof(undo_block_t))) == NULL)
	    return -1;
    }
    if (up->ubp != NULL)
...
static void undo_del_block(undo_t* up)
{
	...
	// put ubp on free list
	ubp->next = up->fubp;
	up->fubp = ubp;
	// ubp1 is the top block
	up->ubp = ubp1;
    }
}

// push empty element on stack and return pointer to element
static undo_elem_t* push(undo_t* up)
{
    undo_elem_t* p;
...
// push undo mark
static int push_mark(undo_t* up, int mark, int save_mark)
{
    undo_elem_t* p = push(up);
    p->type  = MARK;
    p->addr  = (intptr_t*) ((intptr_t)save_mark);
    p->value = mark;
    DBG("PUSH MARK: value=%ld stack=%ld\r\n", p->value, up->stack_size);
    return 0;
}
...
static int push_value(undo_t* up, void* ptr)
{
    ...
    p->type  = VALUE;
    p->addr  = (intptr_t*)ptr;
    p->value = *((intptr_t*)ptr);
    DBG("PUSH VALUE: ptr=%p, value=%ld, stack=%ld\r\n",
	p->addr, p->value, up->stack_size);
    return 0;
}
...
static int push_variable(undo_t* up, variable_t* var)
{
    ...
    p->addr  = (intptr_t*) var;
    // p->value = var->value;
    DBG("PUSH VARIABLE: var=%s, value=%d, stack=%ld\r\n",
	format_variable(var), var->value, up->stack_size);    
    up->value_stack_size++;
    return 0;
}

// pop stack unwind undo blocks skip patched entries update
// stack_size and return the popped element or NULL if empty
// stack.
static inline undo_elem_t* pop(undo_t* up)
{
    while(up->ubp) {
	undo_elem_t* p = --up->cur;
	if (p < up->top) {
	    undo_del_block(up);
	    if (!up->ubp)
		return NULL;
...
// pop & undo single element, return pointer to the element
// return NULL if stack is empty
static undo_elem_t* pop_undo(undo_t* up)
{
    undo_elem_t* p;
    ...
    switch(p->type) {
    case MARK:
	DBG("POP MARK %ld, stack=%ld\r\n",
	    p->value, up->stack_size);
	up->mark = (intptr_t)p->addr;
	break;
    case VARIABLE:
	DBG("POP VARIABLE %s value=%ld, stack=%ld\r\n",
	    format_variable((variable_t*)p->addr),
	    p->value, up->stack_size);
	// ((variable_t*)p->addr)->value = p->value;
	((variable_t*)p->addr)->value = UNDEF;
	up->value_stack_size--;
	break;
    case VALUE:
	DBG("POP VALUE addr=%p value=%ld, stack=%ld\r\n",
	    p->addr, p->value, up->stack_size);
	*p->addr = p->value;
	break;
    case NONE:
	fprintf(stderr, "NONE was popped and that is an error\r\n");
	break;
    default:
	return NULL;
    }
...
// undo until mark
static int pop_until_mark(undo_t* up, int count, int mark)
{
    undo_elem_t* p;

    while((p = pop_undo(up)) != NULL) {
	if (p->type == MARK) {
	    if (count) count--;
	    if ((p->value == mark) || ((mark < 0) && (count == 0)))
		return p->value;
	}
    }
    return 0;
...
static undo_elem_t* find_mark(undo_t* up, int mark)
{
    undo_block_t* ubp = up->ubp;
    undo_elem_t*  top = up->top;
    undo_elem_t*    p = up->cur;

    while(ubp != NULL) {
	p--;
	if (p >= top) {
	    if ((p->type == MARK) && (p->value == mark))
		return p;
	}
	else if ((ubp = ubp->next) != NULL) {
	    top = &ubp->uelem[0];
	    p   = &ubp->uelem[ubp->size];
	}
    }
    return NULL;
}

static void init_variable(variable_t* vptr, int value, int vix)
{
    vptr->next = NULL;
    vptr->flags = 0;    
    vptr->value = value;
...
static int enqueue_variable(varw_t* vp, variable_t* vptr)
{
...
static variable_t* dequeue_variable(varw_t* vp)
{
    variable_t* vptr;
...
static int get_lit(ErlNifEnv* env, varw_t* vp, ERL_NIF_TERM arg, lit_t* xp)
{
    int x;
...
static int get_literal(ErlNifEnv* env, varw_t* vp, ERL_NIF_TERM arg,
		       literal_t** lpp)
{
    lit_t xp;
...
static int get_variable(ErlNifEnv* env, varw_t* vp, ERL_NIF_TERM arg,
		       variable_t** vpp)
{
    lit_t xp;
    if (!get_lit(env, vp, arg, &xp)) return 0;
			     ...
			     const ERL_NIF_TERM argv[])
{
    ...
    if (!(vp = enif_alloc_resource(varw_res, sizeof(varw_t))))
	goto error;
    memset(vp, 0, sizeof(varw_t));
				    ...
				    const ERL_NIF_TERM argv[])
{
    ...
    if ((sp = varw_alloc(&vp->sym_allocator)) == NULL)
	return enif_make_badarg(env);
    sp->is_term = is_term;
    sp->hash = hash;
    sp->var  = var;    
...
//
static int order_reset(varw_t* vp)
{
    int i, u, b;
...
static void order_k_identity(varw_t* vp, int k)
{
    int i;
    for (i = 2; i < (int)vp->vnext; i++) {
...
static void order_k_random(varw_t* vp, int k)
{
    int i;
    for (i = 2; i < (int)vp->vnext; i++) {
...
static void order_k_undefined(varw_t* vp, int k)
{
    int i;
    for (i = 2; i < (int)vp->vnext; i++) {
...
static void order_k_occur(varw_t* vp, int k)
{
    int i;
...
static void order_k_depth(varw_t* vp, int k)
{
    int i;
			     ...
			     const ERL_NIF_TERM argv[])
{
	...
	return enif_make_badarg(env);
    push_mark(&vp->undo, mark, vp->undo.mark);  // mark and save old mark
    vp->undo.mark = mark;                       // set current mark
    return ATOM(true);
}
			      ...
			      const ERL_NIF_TERM argv[])
{
    ...
    if ((count == 0) && (mark != 0)) {
	if (find_mark(&vp->undo, mark) != NULL)
	    goto found;	    
	return enif_make_badarg(env); // mark not found!
    }
found:
    x = pop_until_mark(&vp->undo, count, mark);
    if (x == 0) vp->undo.mark = 0;
    return enif_make_int(env, x);
}
				     ...
				     const ERL_NIF_TERM argv[])
{
    ...
    ubp = vp->undo.ubp;  // current block
    top = vp->undo.top;  // bot in
    p   = vp->undo.cur;    // current in current block
	...
	if (p >= top) {
		...
		else if (mark < 0) { // counting
		    p->type = NONE;  // patch!
		    vp->undo.stack_size--;		    
		    if (--count == 0)
			return enif_make_int(env, p->value);
		}
	    }
	}
	else if ((ubp = ubp->next) != NULL) {
...
static void print_clause(varw_t* vp, char* label, clause_t* cp)
{
    unsigned k;
...
// return -1 conflict
//
static int eval_clause(varw_t* vp, clause_t* cp, int wi)
{
    wlink_t* wl0 = &cp->wl[0];
    wlink_t* wl1 = &cp->wl[1];
    int wp0 = wl0->p;
    ...
    if ((wp0 < 0) || (wp1 < 0)) // dead clause
	return 0;

    if (wi==0) {  // move forward
	p = wp0;
	while((p <= wp1) && ((lv=lit_value(vp,cp->lit[p]))==FALSE))
	    p++;
	DBG("  fwd: %s=%d %d=>%ld\n",
	    lit_format(vp, cp->lit[wp0]),
	    lit_value(vp, cp->lit[wp0]), wp0, p);
	if (p > wp1) // all false
	    return -1;  // conflict
	else {  // watch moved
	    literal_t* mp = lit_literal(vp, cp->lit[p]);
	    if ((p == wp1) && (lv == UNDEF)) {  // unit propagation
		variable_t* var = mp->var;
		push_variable(&vp->undo, var);
		put_literal(vp, cp->lit[p], TRUE, p, cp->cix);
	    }
	    else if (p != wp0) {
		if (lv == UNDEF) {
		    push_value(&vp->undo, &wl0->next);
		    push_value(&vp->undo, &wl0->p);
		    push_value(&vp->undo, &mp->wlist);
		    wl0->p = p;
		    link_wlink(wl0, mp);			
		}
		else {
		    // this can be skipped (debug only?)
		    push_value(&vp->undo, &wl0->next);
		    push_value(&vp->undo, &wl0->p);
		    clear_wlink(wl0);
		}
	...
	p = wp1;
	while((p >= wp0) && ((lv=lit_value(vp,cp->lit[p]))==FALSE))
	    p--;
	DBG("  bwd: %s=%d %ld<=%d\n",
	    lit_format(vp, cp->lit[wp1]),
	    lit_value(vp,cp->lit[wp1]), p, wp1);
	
	if (p < wp0) // all false
	    return -1;  // conflict
	else {
	    literal_t* mp = lit_literal(vp, cp->lit[p]);
	    if ((p == wp0) && (lv == UNDEF)) { // unit propagation
		variable_t* var = mp->var;
		push_variable(&vp->undo, var);
		put_literal(vp, cp->lit[p], TRUE, p, cp->cix);
	    }
		...
		if (lv == UNDEF) {
		    push_value(&vp->undo, &wl1->next);
		    push_value(&vp->undo, &wl1->p);
		    push_value(&vp->undo, &mp->wlist);
		    wl1->p = p;
		    link_wlink(wl1, mp);			
		}
			      ...
			      const ERL_NIF_TERM argv[])
{
	...
	while(wl) {
	    ...
	    if (eval_clause(vp, cp, wlink_index(wl)) < 0) {
			      ...
			      const ERL_NIF_TERM argv[])
{
	...
	return enif_make_int(env, vp->undo.value_stack_size);
    }
    else if (argv[1] == ATOM(number_of_unbound_variables)) {
	return enif_make_int(env, vp->vnum - vp->undo.value_stack_size);
    }
	...
	return enif_make_uint64(env, vp->undo.stack_size);
    }
    else if (argv[1] == ATOM(value_stack_size)) {
	return enif_make_uint64(env, vp->undo.value_stack_size);
    }
...
static ERL_NIF_TERM add_clause_array(ErlNifEnv* env, varw_t* vp, int op,
				     lit_t* lit, size_t size)
{
    ...
    i = size-1;
    while((i > 0) && (lit[i] == VARW_TRUE(vp))) { i--; size--; Tc++; }
    // PRINT_LIT("  del-T", lit, size);

    // remove FALSE literals
    while((i > 0) && (lit[i] == VARW_FALSE(vp))) { i--; size--; Fc++; }
	...
	if (size == 1) {
	    if ((Tc==0) && (Fc>0)) 
		lit[size++] = VARW_FALSE(vp);
	}
	if (Tc>0) // add the T constant to the gate
	    lit[size++] = VARW_TRUE(vp);
	if (lit[0] == VARW_TRUE(vp))
	...
	if (size == 1) {
		...
		lit[size++] = (Tc & 1) ? VARW_TRUE(vp) : VARW_FALSE(vp);
	}
    ...
    // first determine the original watch points
    wp0 = 1;
    wp1 = size-1;
    
    while(wp0 < (int)size) {
	switch(lit_index(cp->lit[wp0])) {
	case FALSE: break;
	case TRUE:  goto dead;
	default: goto next_wp;
	}
	wp0++;
    }
    if (wp0 == (int)size) {  // all literals are false
	// clause_free(vp, cp);
	PRINT_CLAUSE(vp,"contradictory clause: ",cp);	
	return ATOM(false);
    }
next_wp:
    
    while(wp1 > wp0) {
	switch(lit_index(cp->lit[wp1])) {
	case FALSE: break;
	case TRUE:  goto dead;
	default: goto done_wp;
	}
	wp1--;
    }
    
    // wp0 == wp1 unit propagation
    cp->wl[0].p = wp0;
    cp->wl[1].p = wp1;

    switch(lit_value(vp, cp->lit[wp0])) {
    case UNDEF:
    ...
    PRINT_CLAUSE(vp,"unit clause: ",cp);
...
done_wp:
	...
	wlink_t* wl0 = &cp->wl[0];
	wlink_t* wl1 = &cp->wl[1];	
	literal_t* lp0 = lit_literal(vp, cp->lit[wp0]);
	literal_t* lp1 = lit_literal(vp, cp->lit[wp1]);

	set_wlink(wl0, wp0, lp0);
	set_wlink(wl1, wp1, lp1);

	PRINT_CLAUSE(vp,"done clause: ",cp);	

	if (eval_clause(vp, cp, 0) < 0)
	    return ATOM(false);
	if (eval_clause(vp, cp, 1) < 0)
	    return ATOM(false);
    }
    return enif_make_int(env, cix);    
				      ...
				      const ERL_NIF_TERM argv[])
{
	...
	if (p >= top) {
	    ...
	    case VARIABLE:
		if (clause_info) {
		    variable_t* var = (variable_t*) p->addr;
		    elem = enif_make_tuple4(env,
					    enif_make_int(env, var->vix),
					    enif_make_int(env, var->value),
					    enif_make_int(env, var->li),
					    enif_make_int(env, var->cix));
		}
		else {
...
static int varw_load(ErlNifEnv* env, void** priv_data, ERL_NIF_TERM load_info)
{
    ...
    varw_res = enif_open_resource_type(env, 0, "varw", varw_dtor,
...
ERL_NIF_INIT(varc, varw_funcs,
	     varw_load, NULL,
	     varw_upgrade, varw_unload)
