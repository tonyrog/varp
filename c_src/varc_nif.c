...
ErlNifFunc varp_funcs[] = 
{
    ...
    NIF_FUNC( "bcp",                 1,  varp_bcp ),
    NIF_FUNC( "nbcp",                1,  varp_nbcp ),    
    ...
    NIF_FUNC( "get_decision",        2,  varp_get_decision ),
    NIF_FUNC( "get_decision",        3,  varp_get_decision ),
